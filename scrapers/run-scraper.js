...
async function runScraper() {
  ...
  try {
    ...
    console.log(
      `   Fetched ${limitedList.length} articles from listing page\n`
    );
    ...
    console.log(
      `   ⏭️  ${skippedArticles.length} articles unchanged (will skip)`
    );
    ...
    if (articlesToProcess.length > 0) {
      ...
      for (let i = 0; i < articlesToProcess.length; i++) {
        ...
        try {
          ...
          const listingDescription = (article.description || "")
            .substring(0, 200)
            .trim();
          ...
          if (existingData) {
            ...
            await prisma.newsArticle.update({
              ...
              data: {
                ...
                publishedTime: parsePublishTime(
