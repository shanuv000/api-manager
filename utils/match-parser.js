/**
 * Shared Match Parser Utility
 * Parses match cards from Cricbuzz's HTML structure
 * Used by liveScoresNew.js, recentMatches.js, and upcomingMatches.js
 */

const cheerio = require("cheerio");

/**
 * Parse match cards from Cricbuzz HTML
 * @param {string} html - Raw HTML content from Cricbuzz
...
function parseMatchCards(html) {
  ...
  // Find all match cards - they are <a> tags with specific classes
